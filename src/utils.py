...
def filter_dataset_info(objects, object_anomalies, masking_default, rotation_default, category=None):
    if category is None:
        return objects, object_anomalies, masking_default, rotation_default
    ...
    return (
        [category],
        {category: object_anomalies[category]},
        {category: masking_default[category]},
        {category: rotation_default[category]},
    )
